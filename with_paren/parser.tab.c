...
{
       0,    84,    84,    89,    93,    97,   102,   106,   110,   115,
     119,   124
};
#endif
...
{
  "$end", "error", "$undefined", "VARIABLENAME", "PLUS", "MINUS", "TIMES", 
  "DIVIDE", "OPENP", "CLOSEP", "$accept", "Expression", 
  "AdditionExpression", "MultiplicationExpression", "VariableExpression", 
...
#line 90 "parser.y"
    {
                       yyval.node = make_operator_node(yyvsp[-2].node, '+', yyvsp[0].node);
                     ;}
    break;
...
#line 116 "parser.y"
    {
                       yyval.node = make_variable_node(scanner_get_last_variable_name());
                     ;}
    break;
...
#line 125 "parser.y"
    {
                          yyval.node = make_parentheses_node(yyvsp[-1].node);
                        ;}
    break;
